                ...
                <table class="table">
                    <tbody>
                        <tr class="table-secondary">
                            ...
                            <td>
                                <?php
                                echo ( NULL != $project_data ? '<a href="/projects/?view&project_id='.$project_data->getId().'">'.$project_data->getOrdinalNumInYear().' '.$project_data->getClient()->getName().' - '.$project_data->getTitle().'</a>' : '___' )
                                ?>
                            </td>
                            <td></td>
                        </tr>
