            ...
            <form action="<?php echo $_SERVER['PHP_SELF']. '?updateArticle'?>" method="post">
              ...
              <tr>
                ...
                <td class="px-1">
                  ...
                  <!-- TODO -->
                  <a href="<?php echo $_SERVER['PHP_SELF']. '?removeArticle&cutting_sheet_id=' . $cutting_sheet_id .'&cutting_sheet__article_id=' .$cutting_sheet_article->getId() ?>">
          ...
          <tr>
            ...
            <td colspan="5">
              ...
              if ($cutting_sheet_articles):
                ?>
                <a href="<?php echo $_SERVER['PHP_SELF']. '?exportToAccountingDocument&cutting_id=' .$cutting_sheet_id. '&total_picket_lenght=' .$total_picket_lenght. '&total_kap=' .$total_kap. '&picket_width=' . $cutting_sheet_article->getPicketWidth() ?>">
