  ...
  <div class="card mb-2">
    <div class="card-body py-1 px-2">
      ...
      if(isset($_GET['view']) || isset($_GET['edit'])):
        ...
        if(isset($_GET['view'])):
          ?>
          <a href="?edit&cutting_id=<?php echo $cutting_id ?>">
        ...
        if(isset($_GET['edit'])):
          ?>
          <a href="?view&cutting_id=<?php echo $cutting_id ?>">
        ...
        <a href="../tcpdf/examples/printCutting.php?cutting_id=<?php echo $cutting_id ?>" title="PDF [new window]" target="_blank">
