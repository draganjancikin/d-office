      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td colspan="5">
              <a href="<?php echo $_SERVER['PHP_SELF']. '?exportCuttingSheetToAccountingDocument&cutting_id=' .$cutting_sheet_id. '&total_picket_lenght=' .$total_picket_lenght. '&total_kap=' .$total_kap; ?>">
