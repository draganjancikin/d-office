...
if (isset($_GET['set'])):
  ...
  <div class="card mb-4">
    ...
    <div class="card-body p-2">
      <form action="<?php echo $_SERVER['PHP_SELF'] . '?updatePreferences'; ?>" method="post">
        
        <div class="form-group row">
          <label for="inputKurs" class="col-sm-3 col-lg-2 col-form-label text-right">Kurs EUR: </label>
          <div class="col-sm-5">
            <input id="inputKurs" class="form-control" type="text" name="kurs" value="<?php echo $preferences->getKurs(); ?>" required />
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-5">
            <input id="inputTax" class="form-control" type="text" name="tax" value="<?php echo $preferences->getTax(); ?>" required />
          </div>
        </div>
