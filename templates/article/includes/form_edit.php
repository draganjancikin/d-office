...
<div class="card mb-4">
    ...
    <div class="card-body p-2">
        <form action="<?php echo '?updateArticle&article_id=' .$article_id ?>" method="post">
        ...
        foreach ($article_properties as $article_property):
            ...
            <form method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <a href="<?php echo '?removePropertyFromArticle&article_id=' .$article_id. '&property_id=' .$article_property->getId() ?>" class="btn btn-sm btn-danger">
