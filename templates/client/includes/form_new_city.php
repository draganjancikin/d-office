...
<div class="card mb-4">
    <div class="card-header p-2">
        <h6 class="m-0 font-weight-bold">Unos novog naselja </h6>
    </div>
    <div class="card-body">
        <form action="<?php echo '?createCity' ?>" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9 col-md-8 col-lg-9 col-xl-10">
                    <input id="inputName" class="form-control" type="text" name="name" placeholder="Unesite naziv naselja" required />
                </div>
            </div>
            <div class="form-group row">
