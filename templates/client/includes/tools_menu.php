            ...
            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                ...
                if (isset($_GET['view']) || isset($_GET['edit'])):
                    ...
                    <div class="btn-group" role="group" aria-label="Third group">
                        ...
                        <a href="/projects/?new&client_id=<?php echo $client_id ?>" class="btn btn-sm btn-outline-secondary mr-1" title="Otvaranje novog projekta!">
                            <i class="fas fa-arrow-right"></i> Projekat
                        </a>

                        <!-- Open new proforma-invoice with client data. -->
                        <a href="/pidb/?new&client_id=<?php echo $client_id ?>" class="btn btn-sm btn-outline-secondary mr-1" title="Otvaranje novog predračuna!">
                            <i class="fas fa-arrow-right"></i> Predračun
                        </a>

                        <!-- Open new cutting with client data. -->
                        <a href="/cutting/?new&client_id=<?php echo $client_id ?>" class="btn btn-sm btn-outline-secondary" title="Otvaranje nove krojne liste!">
