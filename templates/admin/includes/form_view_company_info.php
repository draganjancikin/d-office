...
<div class="card mb-4">
    <div class="card-header p-2">
        <h6 class="m-0 text-dark">Pregled podataka o kompaniji:</h6>
    </div>
    ...
    <div class="card-body px-2">
        <form>
            <fieldset disabled>
                ...
                <div class="form-group row">
                    <label for="disabledInputNum" class="col-sm-3 col-lg-2 col-form-label text-right text-nowrap">Broj žiro računa1:</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group row">
                    <label for="disabledInputNum" class="col-sm-3 col-lg-2 col-form-label text-right text-nowrap">Broj žiro računa 2:</label>
                    <div class="col-sm-4">
