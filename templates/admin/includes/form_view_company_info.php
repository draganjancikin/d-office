    ...
    <form>
      <fieldset disabled>
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input class="form-control" id="disabledInputName" type="text" value="<?php echo $company->getName() ?>"
              disabled />
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-4">
            <input class="form-control" id="disabledInputPIB" type="text" value="<?php echo $company->getPib() ?>"
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-4">
            <input class="form-control" id="disabledInputMb" type="text" value="<?php echo $company->getMb() ?>"
              maxlength="9" disabled>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-2">
            <input class="form-control" id="disabledInputNum" type="text"
