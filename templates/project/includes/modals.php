...
<div class="modal fade" id="createTask" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo '?view&project_id=' .$project_id. '&createTask' ?>" method="post">
...
<div class="modal fade" id="addNote" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo '?view&project_id=' .$project_id. '&addNote'; ?>" method="post" >
...
<div class="modal fade" id="addFile" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo '?view&project_id=' .$project_id. '&addFile'; ?>" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="addTaskNote" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo '?view&project_id=' .$project_id. '&task_id=' .$task_id. '&addTaskNote'; ?>" method="post" >
