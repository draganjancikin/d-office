            ...
            <fieldset disabled>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5 col-sm-4 col-lg-3">
                        <input class="form-control" id="disabledModified" type="text" value="<?php echo $material->getModifiedAt()->format('d M Y H:i') ?>"
                               disabled />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9 col-xl-8">
                        <input class="form-control" id="disabledInputName" type="text" name="name" value="<?php echo $material->getName(); ?>"
                               disabled />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 col-lg-2">
                        <input class="form-control" id="disabledInputWeight" type="text" name="weight" value="<?php echo $material->getWeight() ?>"
                               disabled />
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 col-lg-2">
                        <input class="form-control" id="disabledInputPrice" type="text" name="price" value="<?php echo $material->getPrice() ?>"
                               disabled />
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9 col-xl-8">
                        <textarea class="form-control" id="disabledInputNote" rows="3" name="note" placeholder="Beleška uz materijal ..." disabled>
                            <?php echo $material->getNote() ?>
                        </textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-3 offset-sm-3 offset-lg-2">
                        <button type="submit" class="btn btn-sm btn-secondary" title="Snimi izmene podataka o klijentu!" disabled>
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" name="property_id">
                                <option value="<?php echo $material_property->getProperty()->getId() ?>">
                                    <?php echo $material_property->getProperty()->getName() ?>
                                </option>
                            </select>
                        </div>
