    ...
    <div class="modal fade" id="addSupplier" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo '?addSupplier&id='.$material_id ; ?>" method="post">
    ...
    <div class="modal fade" id="addProperty" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo '?addProperty&id='.$material_id; ?>" method="post">
                    <input type="hidden" name="id" value="<?php echo $material_id ?>">
