    ...
    <form action="<?php echo $_SERVER['PHP_SELF'] . '?updateMaterial&id=' . $material_id ?>" method="post">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-5 col-sm-4 col-lg-3">
          <input class="form-control" id="disabledModified" type="text"
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-9 col-xl-8">
          <input class="form-control" id="inputName" type="text" name="name" value="<?php echo $material->getName(); ?>"
            maxlength="96">
        </div>
      </div>
      ...
      <div class="form-group row">
        <div class="col-sm-3 offset-sm-3 offset-lg-2"><button type="submit" class="btn btn-sm btn-success"
            title="Snimi izmene podataka o klijentu!"><i class="fas fa-save"></i> Snimi</button></div>
      </div>
