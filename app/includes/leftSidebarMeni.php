<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <?php
    if($userlevel==1 OR $userlevel==2 OR $userlevel==3):
        ?>
    ...
    if($userlevel==1 OR $userlevel==2):
      ...
      <li class="nav-item">
          ...
          <div id="materijal" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                  <a class="collapse-item" href="/material/">Materijal</a>
                  <a class="collapse-item" href="/material/index.php?new"><i class="fas fa-plus"></i> Novi materijal</a>
              </div>
          </div>
      </li>
      ...
      <li class="nav-item">
          ...
          <div id="nabavka" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                  <a class="collapse-item" href="/procuring/">Nabavka</a>
                  <a class="collapse-item" href="/procuring/index.php?new"><i class="fas fa-plus"></i> Nova porudžbenica</a>
              </div>
          </div>
      </li>
