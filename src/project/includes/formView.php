  ...
  <div class="row">
      ...
      <div class="card mb-4">
        ...
        <div class="card-body p-2 client-data">
          <dl class="row mb-0">
            ...
            <dd class="col-sm-8 col-md-9"><a href="/client/index.php?view&client_id=<?php echo $client_data['id'] ?>"><?php echo $client_data['name']; ?></a></dd>
    ...
    <div class="col-sm-7">
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link" id="document-tab" data-toggle="tab" href="#document" role="tab" aria-controls="document" aria-selected="false">Dokumenti</a>
        </li>
      </ul>
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="note" role="tabpanel" aria-labelledby="note-tab">
          <div class="card mb-4">
            <div class="card-header p-2">
              <!--
              <h6 class="d-inline m-0 text-dark w-50">
                <i class="fas fa-pencil-alt"> </i> Beleške
              </h6>
              -->
                ...
                foreach ($notes as $note):
                  ...
                  <tr>
                    ...
                    <td class="px-1">
                      ...
                      <span class="badge badge-secondary"><?php echo ($userlevel==1 ? $note['user_name'] : '' ); ?></span>
                    </td>
                    <td class="px-1">
                      ...
                      <div class="card border-<?php echo $project_task['class']; ?> mb-2">
                        ...
                        <div class="card-header bg-<?php echo $project_task['class']; ?> p-2">
                          ...
                          if($userlevel==1):
                            ?>
                            <small>
                              <?php echo date('d-M-Y', strtotime($project_task['date'])). ', ' .$project_task['user_name']; ?>
                            </small>
                            <?php
                          endif;
                          ?>
                            ...
                            <table>
                              ...
                              foreach ($task_notes as $task_note):
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <span class="direct-chat-name"><?php echo '- ' .$task_note['note']; ?></span>
