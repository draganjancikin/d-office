      ...
      <thead>
        ...
        <tbody>
          ...
          foreach ($articles_on_pidb as $article_on_pidb):
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']. '?editArticleInPidb&pidb_id='.$pidb_id.'&pidb_article_id=' .$article_on_pidb['id']; ?>" class="form-horizontal" role="form" method="post">
              ...
              <tr>
                ...
                <td class="px-1">
                  ...
                  endforeach;
                  ?>
                  <br /><input class="input-box-100" type="text" name="note" value="<?php echo $article_on_pidb['note']; ?>" />
                </td>
            ...
            ?>
            <tr class="table-<?php echo $style; ?>">
              <td colspan="3" rowspan="4"><td colspan="3">ukupno poreska osnovica</td><td class="text-right"><?php echo number_format($total_tax_base*$conf->getKurs(), 2, ",", ".") ?></td><td colspan="5"></td>
            </tr>
            <tr class="table-<?php echo $style; ?>">
            ...
            <tr class="table-<?php echo $style; ?>">
              <td colspan="5"></td><td class="text-right">(eur </td><td class="text-right"><?php echo number_format(($total), 2, ",", ".") ?>)</td><td colspan="2"></td>
            </tr>
