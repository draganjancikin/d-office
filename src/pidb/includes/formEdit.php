        ...
        <div class="table-responsive">
            <table class="table" >
                ...
                <tbody>
                    ...
                    <tr class="table-<?php echo $style; ?>">
                        <td colspan="5">UKUPNO</td><td class="text-right"></td><td class="text-right""><?php echo number_format($total*$pidb->getKurs(), 2, ",", ".") ?></td>
                        <td colspan="2"></td>
                    </tr>
                    <tr class="table-<?php echo $style; ?>">
                        <td colspan="5">Avans</td><td class="text-right"></td><td class="text-right""><?php echo  number_format(($avans = $pidb->getAvans($pidb_id))*$article->getKurs(), 2, ",", ".") ?></td>
                        <td colspan="2"></td>
                    </tr>
                    <tr class="table-<?php echo $style; ?>">
                        <td colspan="5"><strong>OSTALO ZA UPLATU</strong></td><td class="text-right"><strong>RSD</strong></td><td class="text-right""><strong><?php echo number_format(($total-$avans)*$article->getKurs(), 2, ",", ".") ?></strong></td>
