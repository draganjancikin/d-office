...
class Pidb {
    ...
    // $y_id je redni broj dokumenta u okviru jedne godine, na početku svake godine se kreće od 1
    private $y_id;
    
    // $tip_id je tip dokumenta (proforma, invoice, dispatch, "povratnica")
    private $tip_id;
    
    // $date  datum
    private $date;
    
    // $client_id je id klijenta na koga se odnosi dokument
    private $client_id;
    
    // $parent_id je id dokumenta "roditelja", npr. dokument sa $id je dete dokumenta sa $parent_id 
    private $parent_id;
    
    // $title je naslov dokumenta
    private $title;
    
    // $note je belešna (napomena) dokumenta
    private $note;
    
    // $tax porez na dodatnu vrednost
    private $tax;
