  ...
  <div class="card-body p-2">
    ...
    foreach ($suppliers as $supplier):
      ...
      <form action="<?php echo $_SERVER['PHP_SELF'] . '?editMaterialSupplier&material_id=' .$material_id; ?>" method="post">
        ...
        <input class="form-control" type="hidden" name="client_id_temp" value="<?php echo $supplier['id']; ?>" />
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-5">
            <select class="form-control" name="client_id" required>
              ...
              foreach ($clients as $client) {
                // izlistavanje samo pravnih lica
                if($client['vps_id'] == 2){
          ...
          <div class="col-sm-2">
            ...
            <a href="<?php echo $_SERVER['PHP_SELF']. '?edit&material_id=' .$material_id. '&client_id_temp=' .$supplier['id']. '&delMaterialSupplier'; ?>" class="btn btn-mini btn-danger"><i class="fas fa-trash-alt"> </i> </a>
          </div>
