...
class ProjectController extends BaseController {
   ...
   * @return void
   */
  public function addForm($client_id = NULL, $acc_doc_id = NULL): void {
   ...
   * @return void
   */
  public function editForm($project_id): void {
    $project_data = $this->entityManager->find('\App\Entity\Project', $project_id);
   ...
   * @return void
   */
  public function edit($project_id): void {
    $user = $this->entityManager->find("\App\Entity\User", $this->user_id);
   ...
   * @return void
   */
  public function addTask($project_id): void {
    $user = $this->entityManager->find("\App\Entity\User", $this->user_id);
   ...
   * @return void
   */
  public function editTask($project_id, $task_id): void {
    $user = $this->entityManager->find("\App\Entity\User", $this->user_id);
    $project = $this->entityManager->find("\App\Entity\Project", $project_id);
   ...
   * @return void
   */
  public function deleteTask($project_id, $task_id): void {
    $task = $this->entityManager->find("\App\Entity\ProjectTask", $task_id);
   ...
   * @return void
   */
  public function setStartDate($project_id, $task_id): void {
    $task = $this->entityManager->find("\App\Entity\ProjectTask", $task_id);
   ...
   * @return void
   */
  public function setEndDate($project_id, $task_id): void {
    $task = $this->entityManager->find("\App\Entity\ProjectTask", $task_id);
    $start = $task->getStartDate()->format('Y-m-d H:i:s');
   ...
   * @return void
   */
  public function addTaskNote($project_id, $task_id): void {
    $user = $this->entityManager->find("\App\Entity\User", $this->user_id);
    $task = $this->entityManager->find("\App\Entity\ProjectTask", $task_id);
   ...
   * @return void
   */
  public function deleteTaskNote($project_id, $task_id, $note_id): void {
   ...
   * @return void
   */
  public function viewByCity($city_id): void {
   ...
   * @return void
   */
  public function addNote($project_id): void {
    $user = $this->entityManager->find("\App\Entity\User", $this->user_id);
    $project = $this->entityManager->find("\App\Entity\Project", $project_id);
    $note = htmlspecialchars($_POST['note']);
   ...
   * @return void
   */
  public function deleteNote($project_id, $note_id): void {
   ...
   * @return void
   */
  public function printProjectTaskWithNotes($project_id): void {
    $data = [
      'page' => $this->page,
      'entityManager' => $this->entityManager,
      'project_id' => $project_id,
   ...
   * @return void
   */
  public function printProjectTask($project_id): void {
    $data = [
      'page' => $this->page,
      'entityManager' => $this->entityManager,
      'project_id' => $project_id,
   ...
   * @return void
   */
  public function printInstallationRecord($project_id):void {
    $data = [
      'page' => $this->page,
      'entityManager' => $this->entityManager,
      'project_id' => $project_id,
   ...
   * @return void
   */
  public function addFileToProject($project_id): void {
