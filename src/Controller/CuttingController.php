...
//      'user_id' => $this->user_id,
   ...
   * @return void
   */
  public function view($cutting_id): void {
   ...
   * @return void
   */
  public function edit($cutting_id): void {
    $cutting_data = $this->entityManager->find('\App\Entity\CuttingSheet', $cutting_id);
    $client = $this->entityManager->getRepository('\App\Entity\Client')->getClientData($cutting_data->getClient()->getId());
   ...
   * @return void
   */
  public function print($cutting_id): void {
    $data = [
      'entityManager' => $this->entityManager,
      'cutting_id' => $cutting_id,
    ];
   ...
   * @return void
   */
  public function addArticle($cutting_id): void {
   ...
   * @return void
   */
  public function editArticle($cutting_id, $article_id): void {
   ...
   * @return void
   */
  public function deleteArticle($cutting_id, $article_id): void {
    $cutting_sheet__article = $this->entityManager->find("\App\Entity\CuttingSheetArticle", $article_id);
   ...
   * @return void
   */
  public function exportToAccountingDocument($cutting_id, $total_picket_lenght, $total_kap, $picket_width): void {
    $user = $this->entityManager->find("\App\Entity\User", $this->user_id);
   ...
   * @return void
   */
  public function delete($cutting_id): void {
