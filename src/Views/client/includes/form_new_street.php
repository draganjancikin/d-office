...
<div class="card mb-4">
  ...
  <div class="card-body">
    <form action="/clients/addStreet" method="post">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-9 col-md-8 col-lg-9 col-xl-10">
          <input id="inputName" class="form-control form-control-sm" type="text" name="name" placeholder="Unesite naziv ulice" required />
        </div>
      </div>
      <div class="row mb-2">
