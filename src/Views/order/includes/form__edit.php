  ...
  <div class="card-body p-2">
    <dl class="row mb-0">
      ...
      <dd class="col-sm-9 col-md-10">
        <?php echo ($supplier_data['street'] ?? "") . ' ' . $supplier_data['home_number']
          . ($supplier_data['street'] && $supplier_data['city'] ? ", " : "")
          . ($supplier_data['city'] ?? "")
          . ($supplier_data['city'] && $supplier_data['country'] ? ", " : "")
    ...
    <div class="table-responsive">
      <table class="table table-hover" >
        ...
        <tbody>
          ...
          foreach ($materials_on_order as $material_on_order):
            $count++;
            ?>
            <form action="<?php echo '/order/' . $order_id . '/material/' . $material_on_order->getId() . '/edit' ?>"
                  method="POST">
              ...
              <tr>
                ...
                <td class="px-1 input-box-65">
                  <?php
                  $tax_base = $entityManager->getRepository('\App\Entity\OrderMaterial')->getTaxBase($material_on_order->getPrice(), $material_on_order->getDiscount(), $material_on_order_quantity);
                  echo number_format($tax_base * $kurs, 2, ",", ".")
                  ?>
                </td>
                <td class="px-1 text-center"><?php echo $material_on_order->getTax() ?></td>
                <td class="px-1 input-box-45">
                  <?php $tax_amount = $entityManager->getRepository('\App\Entity\OrderMaterial')->getTaxAmount($tax_base, $material_on_order->getTax() );
                ...
                <td class="px-1 text-center">
                  ...
                  <a href="<?php echo '/order/' . $order_id . '/material/' . $material_on_order->getId() . '/edit' ?>"
                     class="btn btn-mini btn-outline-info px-1">
                    <i class="fas fa-edit" title="Promeni materijal"> </i>
                  </a>

                  <a href="<?php echo '/order/' . $order_id . '/material/' . $material_on_order->getId() . '/duplicate'
                  ?>"
                     class="btn btn-mini btn-outline-info px-1">
                  ...
                  <a onClick="javascript: return confirm('Da li ste sigurni da želite da obrišete materijal?');"
                     href="<?php echo '/order/' . $order_id . '/material/' . $material_on_order->getId() . '/delete' ?>"
      ...
      <form action="<?php '/order/' . $order_id . '/edit' ?>" method="post">
                ...
                <tr class="table-secondary">
                    ...
                    <td>
                        ...
                        <select class="form-control" name="project_id">
                            ...
                            <?php
                            $project_list = $entityManager->getRepository('App\Entity\Project')->getAllActiveProjects();
                    ...
                    <td>
                        <div class="form-check">
                            <input class="form-check-input"
                                   ...
                                   id="draft"
                                   value="0"
                                   <?php if ($order_data->getStatus() == 0) echo 'checked'; ?> >
                        ...
                        <div class="form-check">
                            <input class="form-check-input"
                                   ...
                                   id="ordered"
                                   value="1"
                                   <?php if ($order_data->getStatus() == 1) echo 'checked'; ?> >
                        ...
                        <div class="form-check">
                            <input class="form-check-input"
                                   ...
                                   id="arrived"
                                   value="2"
                                   <?php if ($order_data->getStatus() == 2) echo 'checked'; ?> >
                    ...
                    <td>
                        <div class="form-check">
                            <input class="form-check-input"
                                   ...
                                   name="is_archived"
                                   value="1"
                                   <?php echo ($order_data->getIsArchived() == 0 ? '' : 'checked') ?> >
