  ...
  <div class="card-body p-2">
    <form action="<?php echo '/orders/add'; ?>" method="post">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <input id="inputTitle" class="form-control form-control-sm" type="text" name="title"
      ...
      <div class="row mb-2">
        ...
        <div class="col-md-6 col-sm-10">
          <textarea class="form-control form-control-sm" rows="3" name="note" placeholder="Unesite belešku uz narudžbenicu"></textarea>
        </div>
      </div>
