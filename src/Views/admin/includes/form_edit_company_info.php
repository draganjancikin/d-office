...
<div class="card mb-4">
    ...
    <div class="card-body px-2">
        <form action="<?php echo '/admin/company-info/edit'?>" method="post">
            ...
            <div class="row mb-2">
                <label for="inputName" class="col-sm-3 col-lg-2 col-form-label text-right">
                    Naziv:
                </label>
                <div class="col-sm-6">
            ...
            <div class="row mb-2">
                <label for="inputPIB" class="col-sm-3 col-lg-2 col-form-label text-right">
                    PIB:
                </label>
                <div class="col-sm-4">
                    <input class="form-control form-control-sm"
            ...
            <div class="row mb-2">
                <label for="inputMb" class="col-sm-3 col-lg-2 col-form-label text-right">
                    MB:
                </label>
                <div class="col-sm-4">
                    <input class="form-control form-control-sm"
            ...
            <div class="row mb-2">
                <label for="selectCountry" class="col-sm-3 col-lg-2 col-form-label text-right">
                    Država:
                </label>
                <div class="col-sm-4">
            ...
            <div class="row mb-2">
                <label for="selectCity" class="col-sm-3 col-lg-2 col-form-label text-right">
                    Naselje:
                </label>
                <div class="col-sm-4">
            ...
            <div class="row mb-2">
                <label for="inputNum" class="col-sm-3 col-lg-2 col-form-label text-right">
                    Broj:
                </label>
                <div class="col-sm-2">
                    <input class="form-control form-control-sm"
            ...
            <div class="row mb-2">
                <label for="inputBankAccount1" class="col-sm-3 col-lg-2 col-form-label text-right">
                    Broj žiro računa 1:
                </label>
                <div class="col-sm-4">
                    <input class="form-control form-control-sm"
                           id="inputBankAccount1"
                           type="text"
                           name="bank_account_1"
            ...
            <div class="row mb-2">
                <label for="inputBankAccount2" class="col-sm-3 col-lg-2 col-form-label text-right">
                    Broj žiro računa 2:
                </label>
                <div class="col-sm-4">
                    <input class="form-control form-control-sm"
                           id="inputBankAccount2"
                           type="text"
                           name="bank_account_2"
            ...
            <div class="row mb-2">
                <label for="inputPhone1" class="col-sm-3 col-lg-2 col-form-label text-right">
                    Telefon 1:
                </label>
                <div class="col-sm-4">
                    <input class="form-control form-control-sm"
                           ...
                           type="text"
                           name="phone_1"
                           value="<?php echo $company->getPhone1() ?>" />
                </div>
            </div>

            <div class="row mb-2">
                <label for="inputPhone2" class="col-sm-3 col-lg-2 col-form-label text-right">
                    Telefon 2:
                </label>
                <div class="col-sm-4">
                    <input class="form-control form-control-sm"
                           ...
                           type="text"
                           name="phone_2"
                           value="<?php echo $company->getPhone2() ?>" />
                </div>
            </div>

            <div class="row mb-2">
                <label for="inputEmail1" class="col-sm-3 col-lg-2 col-form-label text-right">
                    Email 1:
                </label>
                <div class="col-sm-4">
                    <input class="form-control form-control-sm"
                           ...
                           type="email"
                           name="email_1"
                           value="<?php echo $company->getEmail1() ?>" />
                </div>
            </div>

            <div class="row mb-2">
                <label for="inputEmail2" class="col-sm-3 col-lg-2 col-form-label text-right">
                    Email 2:
                </label>
                <div class="col-sm-4">
                    <input class="form-control form-control-sm"
                           ...
                           type="email"
                           name="email_2"
                           value="<?php echo $company->getEmail2() ?>" />
                </div>
            </div>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-4">
                    <input class="form-control form-control-sm"
                           ...
                           type="text"
                           name="website_1"
                           value="<?php echo $company->getWebsite1() ?>" />
                </div>
            </div>
