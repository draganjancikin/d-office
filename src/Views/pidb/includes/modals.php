...
<div class="modal" id="addArticle" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/pidb/<?php echo $pidb_id ?>/addArticle" method="post" role="form">
        ...
        <div class="modal-body">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-9">
              <div id="first">
                <select class="form-select form-select-sm" name="article_id" id="article">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control form-control-sm" name="pieces" id="pieces" value="" placeholder="Unesite količinu" />
            </div>
          </div>
...
<div class="modal" id="addPayment" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/pidb/<?php echo $pidb_id ?>/addPayment" method="post" role="form">
        <input type="hidden" name="pidb_id" value="<?php echo $pidb_id ?>">
        ...
        <div class="modal-body">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-9">
              <select class="form-select form-select-sm" name="pidb_id" id="pidb">
