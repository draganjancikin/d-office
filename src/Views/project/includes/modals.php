      ...
      <form action="<?php echo '/project/' . $project_id . '/task/add' ?>" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <select id="selectTip" name="type_id" class="form-select form-select-sm" required="required">
    ...
    <div class="modal-content">
      ...
      <form action="<?php echo '/project/' .$project_id. '/note/add' ?>" method="post" >
        ...
        <div class="modal-body">
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <textarea class="form-control form-control-sm" rows="3" name="note"
                        placeholder="Upišite belešku"></textarea>
            </div>
          </div>
    ...
    <div class="modal-content">
      ...
      <form action="<?php echo '/project/' . $project_id . '/addFile'; ?>" method="post"
        ...
        <div class="modal-body">
          <div class="row mb-2">
            <div class="col-sm-12">
              <label for="inputFile" class="form-label">Izaberi faj:</label>
              <!-- <input type="hidden" name="project_id" value="<?php echo $project_id; ?>"> -->
              <input type="file" class="form-control" name="file" id="inputFile"
                     title="Niste izabrali fajl!">
            </div>
          </div>
        </div>
    ...
    <div class="modal-content">
      ...
      <form action="<?php echo '/project/' . $project_id . '/task/' . $task_id . '/addNote' ?>"
        ...
        <div class="modal-body">
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <input type="text" class="form-control form-control-sm" name="note" value=""
