        ...
        <div class="card mb-4">
          <div class="card-header p-2">
            <div class="card-header-menu">
              ...
              <!-- Pregled i štampanje radnog naloga sa beleškama uz projekat -->
              <a href="/project/<?php echo $project_id ?>/printProjectTaskWithNotes" title="Izvoz radnog naloga sa beleškama u PDF [new window]" target="_blank">
                ...
                <tr>
                  ...
                  <td class="px-1">
                    <a onClick="javascript: return confirm('Da li ste sigurni da želite da obrišete belešku?');"
                       href="/project/<?php echo $project_id; ?>/note/<?php echo $note->getId() ?>/delete"
          ...
          <div class="card-body p-2 tasks-note-scroll">
            ...
            if ($accounting_documents = $entityManager->find("\App\Entity\Project", $project_id)->getAccountingDocuments()):
              ...
              foreach ($accounting_documents as $accounting_document):
                ?>
                <a href="/pidb/<?php echo $accounting_document->getId()?>">
                    ...
                    <div class="card border-<?php echo $project_task->getType()->getClass() ?> mb-2">
                      ...
                      <div id="collapse<?php echo $count ?>" class="collapse" >
                        ...
                        <div class="card-footer p-2">
                          ...
                          <a onClick="javascript: return confirm('Da li ste sigurni da želite da obrišete ' +
                           'zadatak?');" href="/project/<?php echo $project_id; ?>/task/<?php echo
                          $project_task->getId() ?>/delete">
                          ...
                          <a href="/project/<?php
                          echo $project_id; ?>/task/<?php echo $project_task->getId() ?>/edit">
...
<!--                        <div class="col mb-4">-->
                  ...
                  <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 mb-4">
                    <div class="card">
                        <a href="/upload/projects/project_id_<?php echo $project_id.'/'.$entry; ?>" target="_blank" class="p-1">
                        <img class="card-img-top" src="/upload/projects/project_id_<?php echo $project_id. '/'
                          .$entry; ?>" alt="Attachment">
                        </a>
                            <div class="card-body">
