<div class="card mb-4">
  ...
  <div class="card-body p-2">
    <form action="<?php echo '/project/' . $project_id . '/edit' ?>" method="post">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-8">
          <input id="inputTitle" type="text" class="form-control form-control-sm" name="title"
                 value="<?php echo $project_data->getTitle() ?>" maxlength="64" placeholder="Unesite naslov projekta">
        </div>
      </div>
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-4">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="status_id" id="active"
                   value="1" <?php echo ( $project_data->getStatus()->getId() == 1 ? 'checked' : ''); ?>>
            <label class="form-check-label" for="active">Aktivan</label>
          </div>

          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="status_id" id="wait"
                   value="2" <?php echo ( $project_data->getStatus()->getId() == 2 ? 'checked' : ''); ?>>
            <label class="form-check-label" for="wait">Na čekanju</label>
          </div>

          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="status_id" id="archived"
                   value="3" <?php echo ( $project_data->getStatus()->getId() == 3 ? 'checked' : ''); ?>>
