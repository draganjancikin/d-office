...
<div class="card mb-4">
  <div class="card-header p-2">
    <h6 class="m-0 text-dark">Pregled podataka o klijentu: <strong><?php echo $client_data['name']; ?></strong></h6>
  </div>
    ...
    <form>
      <fieldset disabled>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-7">
            <input class="form-control" id="disabledInputNum" type="text" value="<?php echo $client_data['adress_note']; ?>" disabled />
          </div>
        </div>
        ...
        <form>
          <fieldset disabled>
            <div class="form-group row">
              ...
              <div class="col-sm-2">
                <button type="submit" class="btn btn-mini btn-secondary disabled" title="Snimi izmenu kontakta!"><i class="fas fa-save"> </i> </button>
                <a href="<?php echo $_SERVER['PHP_SELF']. '?edit&client_id=' .$client_id. '&contact_id=' .$contact['id']. '&delContact'; ?>" class="btn btn-mini btn-secondary disabled" title="Obriši kontakt!"><i class="fas fa-trash"> </i> </a>
              </div>
