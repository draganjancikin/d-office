...
class ProjectNote
{
    ...
    /**
     * Identifier of the project note.
     *
     * @var int
     */
    #[ORM\Id]
    ...
    /**
     * Many Project Notes belongs to the One Project.
     *
     * @var int
     */
    ...
    /**
     * Date and time when the project note was created.
     *
     * @var DateTime
     */
    ...
    /**
     * Many ProjectNotes has ben created from One User.
     *
     * @var int
     */
    ...
    /**
     * Date and time when the project note was last modified.
     *
     * @var DateTime
     */
    #[ORM\Column(type: 'datetime', options: ['default' => 'CURRENT_TIMESTAMP'])]
    ...
    /**
     * Many ProjectNotes has ben updated from One User.
     *
     * @var int
     */
    #[ORM\ManyToOne(targetEntity: User::class)]
